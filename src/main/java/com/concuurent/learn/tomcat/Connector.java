...
/**
 * connector是一个桥梁，它把Server和Engine连接了起来，
 * Connector的作是接受客户端的请求，然后把请求委托给Engine容器处理。
 * 在Connector的内部具体使用Endpoint进行处理，
 * 根据处理方式的不同Endpoint可分为NioEndpoint、JloEndpoint、AprEndpoint。
 * 本节介绍NioEndpoint中的并发组件队列的使用。为了让读者更好地理解，有必要先说下NioEndpoint的作用。
 * @author Wesley
 * 2019年7月9日下午4:51:48
 * @Version 1.0
 */
...
//     protected MapperListener mapperListener = new MapperListener(mapper, this);
     protected MapperListener mapperListener = new MapperListener(mapper, null);
...
//    }
    ...
    protected void initInternal() throws LifecycleException {
        ...
        // Initialize adapter
        adapter = null;//new CoyoteAdapter(this);
