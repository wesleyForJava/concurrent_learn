...
/**
 * 可以看到，每个SimpleDateFormat实例里面都有一个Calendar对象，
 * 后面我们就会知道，SimpleDateFormat所以是线程不安全的，
 * 就是因为Calendar是线程不安全的后者之所以是线程不安的，
 * 是因为其中存放日期数据的变量都是线程不安全的，
 * 比如fields、time等。
 * @author Wesley
 *
 * 2019年7月10日下午3:29:52
...
//    @Override
  public Date parse(String text, ParsePosition pos)
  {
	  ...
	  //1.解析日期字符串，并将待解析好的数据放入实例 CalendarBuilder的calb中
...
//            parsedDate = calb.establish(calendar).getTime();
            parsedDate = calb.establish(null).getTime();
...
//        return parsedDate;
	  return null;
/**
 * 代码(1）的主要作用是解析日期字串并把解析好的数据放入CalendarBuilder的实例calb中。
...
//    }
/**
 * 本节通过简单介绍SimpleDateFormat的原理解释了为何SimpleDateFormat是线程不安全的，
 * 应该避免在多线程下使用SimpleDateFormat的单个实例。
 */
}
